...
public class DaoGenericoImpl<T, ID extends Serializable> implements DaoGenerico<T, ID> {
    ...
    public void delete(T objeto) {
        try {
            ...
            cancel();
            logger.error("Erro ao deletar", hibernateException);
            throw hibernateException;
        }
    }
    ...
    public void deleteItem(T objeto) {
        try {
            ...
            cancel();
            logger.error("Erro ao deletarItem", hibernateException);
            throw hibernateException;
        }
    }
    ...
    public List<T> list() {
        try {
            ...
            cancel();
            logger.error("Erro ao listar", hibernateException);
            throw hibernateException;
        }
    }
    ...
    public T getById(Serializable id) {
        try {
            ...
            cancel();
            logger.error("Erro ao resgatar pelo id", hibernateException);
            throw hibernateException;
        }
    }
    ...
    public List<T> listCriterio(String subClazz, Map<String, Object> filtrosConsulta, int tipoConsulta) {
        ...
        try {
            ...
            cancel();
            logger.error("Erro listar", hibernateException);
            throw hibernateException;
        }
    }
